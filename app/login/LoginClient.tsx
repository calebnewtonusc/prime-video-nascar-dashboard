      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 14 }}>
            <Image src="/prime-video-logo.png" alt="Prime Video" height={72} width={180} style={{ height: 72, width: "auto" }} />
            <div style={{ width: 1, height: 64, background: "#1A2437", flexShrink: 0 }} />
            <Image src="/nascar-logo-white.png" alt="NASCAR" height={56} width={140} style={{ height: 56, width: "auto" }} />
          </div>
